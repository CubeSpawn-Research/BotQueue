...
var _componentsMenuVue = require('./components/menu.vue');

var _componentsMenuVue2 = _interopRequireDefault(_componentsMenuVue);

exports['default'] = {
    components: {
        'bq-menubar': _componentsMenuVue2['default']
    }
};
module.exports = exports['default'];
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n    <div class=\"container\">\n\n        <bq-menubar></bq-menubar>\n\n        <section id=\"content\" style=\"margin-top:60px\">\n            <!--\n            @ifSection('title')\n            <div class=\"page-header\">\n                <h1>@yield('title')</h1>\n            </div>\n            @endif\n            -->\n\n            <div class=\"row\">\n                <div class=\"span12\">\n                    <router-view></router-view>\n                </div>\n            </div>\n\n            <br><br>\n\n            <div class=\"alert alert-info\">\n                <strong>Hey You!</strong> If you run into any problems, please <a href=\"https://github.com/Hoektronics/BotQueue/issues/new\">report a bug</a>. Make sure to include the\n                <strong>bumblebee/info.log</strong> file if it is client-related.\n            </div>\n\n        </section>\n\n        <footer>\n            <div class=\"row\">\n                <div class=\"span6\">\n                    <h3>Connect</h3>\n                    <a href=\"http://www.hoektronics.com\">Blog</a><br>\n                    <a href=\"https://twitter.com/hoeken\">Twitter</a><br>\n                    <a href=\"irc://irc.freenode.net/botqueue\">Freenode #BotQueue</a><br>\n                    <a href=\"https://groups.google.com/d/forum/botqueue\">Google Group</a><br>\n                </div>\n                <div class=\"span6\">\n                    <h3>Info</h3>\n                    Made by Zach Hoeken and Justin Nesselrotte. (<a v-link=\"{ path: '/about' }\">about</a>)<br>\n                    Software licensed under the <a href=\"http://www.gnu.org/copyleft/gpl.html\">GPL v3.0</a>. Code at <a href=\"https://github.com/Hoektronics/BotQueue\">GitHub</a>.<br>\n                    © <!--?= date(\"Y\") ?--> <a href=\"http://www.hoektronics.com\">Hoektronics</a>. Powered by <a href=\"http://www.botqueue.com\">BotQueue</a>.<br>\n                    Page generated in <!--?= round(microtime(true) - LARAVEL_START, 3) ?--> seconds.\n                </div>\n            </div>\n            <br>\n        </footer>\n\n    </div>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/home/jnesselr/PhpstormProjects/BotQueue/resources/assets/vue/App.vue"
  if (!module.hot.data) {
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/home/jnesselr/PhpstormProjects/BotQueue/resources/assets/vue/components/menu.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, module.exports.template)
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/home/jnesselr/PhpstormProjects/BotQueue/resources/assets/vue/pages/Auth/Login.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, module.exports.template)
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/home/jnesselr/PhpstormProjects/BotQueue/resources/assets/vue/pages/Auth/Logout.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, module.exports.template)
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/home/jnesselr/PhpstormProjects/BotQueue/resources/assets/vue/pages/Auth/Register.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, module.exports.template)
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/home/jnesselr/PhpstormProjects/BotQueue/resources/assets/vue/pages/Home/About.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, module.exports.template)
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/home/jnesselr/PhpstormProjects/BotQueue/resources/assets/vue/pages/Home/Welcome.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, module.exports.template)
...
exports['default'] = {
    ...
    computed: {
        total: function total() {
            var self = this;
            var values = _Object$keys(self.queues).map(function (key) {
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/home/jnesselr/PhpstormProjects/BotQueue/resources/assets/vue/pages/Queue/Index.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, module.exports.template)
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/home/jnesselr/PhpstormProjects/BotQueue/resources/assets/vue/pages/Queue/View.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, module.exports.template)
